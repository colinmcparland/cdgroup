...
//  Add projects to markets section
function add_featured_projects_to_markets($field) {
	$args = array(
  	'numberposts' => -1,
	...
	foreach($posts as $post) {
		$choices_arr[$post->ID] = $post->post_title;
	}


	$field['choices'] = $choices_arr;

	return $field;
}
add_filter('acf/load_field/name=featured_projects', 'add_featured_projects_to_markets');
add_filter('acf/load_field/name=featured_project_cta_select', 'add_featured_projects_to_markets');
